/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 37f80383fc6c5809a1d6d66af20cb4cc)
// Runtime types generated with workerd@1.20260312.1 2026-03-12 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserGateway";
	}
	interface Env {
		PHOTOS_BUCKET: R2Bucket;
		DB: D1Database;
		JWT_ISSUER: "auth.genzyy.in";
		JWT_AUDIENCE: "genzyy-app";
		R2_BUCKET_NAME: "genzyy-convo";
		NODE_API_URL: "https://datingapp-api-820618709776.asia-south1.run.app";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ISSUER" | "JWT_AUDIENCE" | "R2_BUCKET_NAME" | "NODE_API_URL">> {}
}
